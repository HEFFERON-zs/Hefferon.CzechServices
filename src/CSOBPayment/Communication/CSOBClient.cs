...
using System.Web;
using Hefferon.CzechServices.CsobPayment.Common;
using Hefferon.CzechServices.CsobPayment.Communication.DataObjects;
using Hefferon.CzechServices.CsobPayment.Security;
using Newtonsoft.Json;

namespace Hefferon.CzechServices.CsobPayment.Communication
{
    public class CSOBClient
    {
        ...
        public async Task<ClientResponse> CallInitAsync(PayInitReq request)
        {
            FillAndSign(request);
